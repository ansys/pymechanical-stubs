...
but provides practical examples of how you use the APIs in Mechanical, whereas the `ACT API Reference Guide`_ and
the Mechanical API Documentation (this site) contain a complete listing of all supported APIs.

- `Scripting in Mechanical Guide`_
- `ACT API Reference Guide`_ (reproduced on this site using Sphinx)

Click the `API reference <api/index.html>`_
